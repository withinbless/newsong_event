...
function insert_event_result($event_type) {
    ...
    if ($conn->connect_error) {
        ...
        $insert_event_result_query = 
            "INSERT INTO newsong_event_result ( event_id, team_id, rank, is_win, base_score, extra_score ) VALUES ('$GLOBALS[event_id]', '$GLOBALS[team_id]', $rank, '$GLOBALS[is_win]', $base_score, $extra_score)";
